...
Flexbox & Grid: Para layouts modernos e adaptáveis.

Keyframes: Para animações de interface.

JavaScript (Vanilla): Lógica pura para manipulação de vídeo e eventos de formulário.
...
Irisney (Consultoria Técnica)

Fran (Auditoria e Documentação)
